function webmarker_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
webmarker_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				webmarker_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
webmarker_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
webmarker_xmlhttpRequester.prototype.setupRequestEvent =
